...
<head>
    ...
    <title>Designations - Role Based System</title>
...
<body data-catalog-type="designations" data-catalog-label="Designation">
    <div class="navbar" id="navbar">
        <h1 id="navbarTitle" class="navbar-title">
            ...
            <span id="navbarTitleText">Designations</span>
        </h1>
    ...
    <div class="page-wrapper">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/designations" class="nav-item active" data-page="designations" data-roles="admin">
            ...
            <div class="container">
                ...
                <div class="users-header">
                    ...
                    <div class="users-header-actions">
                        <button class="add-user-btn" onclick="openAddCatalogModal()">Add Designations</button>
                    </div>
                </div>

                <div class="search-bar">
                    <input type="text" id="catalogSearchInput" placeholder="Search designations by name..." onkeyup="filterCatalogItems()">
                </div>
                ...
                <table class="users-table" id="catalogTable">
                    ...
                    <tbody id="catalogTableBody">
                        <tr>
                            <td colspan="2" class="loading">Loading designations...</td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div id="addCatalogModal" class="modal-overlay hidden" role="dialog" aria-modal="true" aria-labelledby="addCatalogModalTitle">
        <div class="modal-card">
            <div class="modal-header">
                <h3 id="addCatalogModalTitle">Add Designations</h3>
            ...
            <form id="addCatalogForm" class="modal-form">
                <div class="modal-grid one-col">
                    <div class="form-field">
                        <label for="catalogNameInput">Designation Name</label>
                        <input id="catalogNameInput" type="text" placeholder="Enter designation name" required>
                    </div>
                </div>
                <div class="modal-actions">
                    <button type="button" class="action-btn" onclick="closeAddCatalogModal()">Cancel</button>
                    <button type="submit" class="add-user-btn">Add Designations</button>
                </div>
            </form>
        </div>
    </div>
